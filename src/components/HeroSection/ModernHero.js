...
const ModernHero = () => {
  ...
  return (
    <main className="hero bg-[#020617] text-white min-h-screen relative overflow-x-hidden">
      <section className="hero min-h-screen flex items-center justify-center relative px-5 sm:px-6 lg:px-8 py-10 md:py-16 lg:py-0">
        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-8 md:py-10 lg:py-12 pt-20 md:pt-28 xl:pt-28">
          {/* Left column - Text content */}
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0 relative text-center lg:text-left">
            {/* Decorative blurs */}
            ...
            {/* Welcome badge */}
            <motion.div 
              className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 mb-4 sm:mb-8"
            ...
            <div className="relative mb-4 sm:mb-8">
              ...
              >
                ...
                <span className="relative inline-block">
                  <span className="bg-gradient-to-r from-[#1E90FF] to-[#00FFFF] bg-clip-text text-transparent">
                    {Bio.name}
                  </span>
                </span>
              </motion.h1>
            ...
            {/* Role badge */}
            <motion.div 
              className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#1E90FF]/10 to-[#00FFFF]/10 border border-[#1E90FF]/20 mb-4 sm:mb-8 backdrop-blur-sm"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.3 }}
            >
              <i className="fas fa-rocket text-blue-400 text-sm sm:text-base"></i>
              <span className="text-base sm:text-xl text-blue-400 font-medium">
            ...
            {/* Description */}
            <motion.div 
              className="relative mb-6 sm:mb-12 max-w-xl mx-auto lg:mx-0"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 }}
            >
              <p className="text-sm sm:text-xl text-gray-300/90 leading-relaxed">
            ...
            {/* CTA Buttons */}
            <motion.div 
              className="flex flex-row gap-3 sm:gap-6 items-center justify-center lg:justify-start"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <a
                href="#contact"
                className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-r from-[#1E90FF] to-[#00FFFF] px-4 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#1E90FF]"
              >
              ...
              <a
                href="#projects"
                className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-8 py-3 sm:py-4 rounded-xl bg-slate-800/50 backdrop-blur-sm border border-slate-600/50 transition-all duration-300 hover:scale-105 hover:border-blue-500/50 hover:bg-slate-800/80"
              >
            ...
            >
              ...
              <a
                ...
                className="group w-10 h-10 sm:w-12 sm:h-12 bg-slate-800/50 backdrop-blur-sm border border-slate-600/50 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-blue-500/50 hover:bg-slate-800/80"
              >
              ...
              <a
                ...
                className="group w-10 h-10 sm:w-12 sm:h-12 bg-slate-800/50 backdrop-blur-sm border border-slate-600/50 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-green-500/50 hover:bg-slate-800/80"
              >
          ...
          >
            <div className="w-full p-[1px] rounded-lg bg-gradient-to-r from-cyan-500 via-blue-500 to-pink-500">
              ...
              {/* Code content */}
              <div className="bg-[#031321] p-3 sm:p-4 md:p-6 overflow-x-auto">
                <pre className="text-[11px] sm:text-[13px] md:text-[15px] leading-[1.5] sm:leading-[1.6] font-mono">
